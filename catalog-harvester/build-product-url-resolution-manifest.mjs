...
import { buildProductUrlResolutionManifest } from './product-url-resolution-manifest.mjs';

const root = path.resolve(path.dirname(fileURLToPath(import.meta.url)), '..');
const [
  outputArg = 'catalog-harvester/manifests/product-url-resolution.json',
  limitArg = '100',
...
const manifest = buildProductUrlResolutionManifest({
